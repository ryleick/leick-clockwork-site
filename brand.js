...
(function(){
  ...
  // three interlocking gears (reads as a mechanism, not a sun) — line-art style
  function gearCluster(){
    function g(cx,cy,rt,rv,t){
      return '<path d="'+gearPath(cx,cy,rt,rv,t)+'" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/>'
        +'<circle cx="'+cx+'" cy="'+cy+'" r="'+(rv*0.42)+'" fill="none" stroke="currentColor" stroke-width="1.5"/>';
    }
    return '<svg width="28" height="28" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">'
      + g(15,17,9,6.6,9) + g(28,12.5,6.4,4.4,7) + g(26.5,28,5.6,3.8,6)
      + '</svg>';
  }
